...
import {getTipoServicioAllService} from "../services/TipoServicioService.js";

/**
 * @description Obtiene todos los tipos de servicio.
...
export const getTipoServicioAll = async (request, reply) => {
    try {

        let resultado = await getTipoServicioAllService()
