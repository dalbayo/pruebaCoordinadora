...
export const ERRORES_HTTP={
  ...
  "200": {
    "code": 200,
    "message": "OK",
    "description": "La solicitud es correcta (esta es la respuesta estándar para solicitudes HTTP exitosas)."
  },
  "201": {
    "code": 201,
    "message": "Created",
  ...
  "400": {
    "code": 400,
    "message": "Bad Request",
    "description": "La solicitud no se puede responder debido a una sintaxis incorrecta."
  },
  "401": {
    "code": 401,
    "message": "Unauthorized",
    "description": "La solicitud es legal, pero el servidor se niega a responderla. Para usar debe tener una autenticación valida."
  },
  "402": {
    "code": 402,
  ...
  "500": {
    ...
    "description": "Se ha producido un error en un script del lado del servidor "
  },
  "501": {
    "code": 501,
